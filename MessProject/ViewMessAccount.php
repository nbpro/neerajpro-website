...
<?php include "config.php"?>
    ...
    {
       echo "<tr><td align=center>". $i++ ."</td><td align=center>{$row['date']}</td><td align=center>{$row['items']}</td><td align=center>Rs.    {$row['expense']}/-</td><td align=center><font color=blue>Rs.{$row['balance']}/-</font></td><td align=center>{$row['depositor']}</td><td align=center>Rs.{$row['deposite']}/- </td>  </tr>\n";
