...
<?php 
	if(isset($_POST['Submit']))
	{
		...
		$query1= "SELECT pwd FROM admin where pwd='$opwd'";
	...
	if(mysql_num_rows( $res )==0  )
	{
	 ...
	 echo('<br><font color=red size=5><a href="../adminpage.php" target="_parent">Click here</a></font><font color=blue size=5>&nbsp;to Return Home.</font></center>');

	 exit;
	}
	else
	{
		$query2=mysql_query("update admin set pwd='$pwd' where pwd='$opwd'");
