...
<?php 
	...
	{ 
	 echo '<body bgcolor=#00ff99><font size=10 color=blue><br><br><br><center>'. $name .' Returned <font color=red><u>Rs. '. $ramt .'/-</u></font><br>Total Borrowed Ammount by '. $name .' is <font color=red><u>Rs. '. $namt .'/-</u></font></center></font>';
	exit;
	}
}
...
<form action="<?php $_PHP_SELF ?>" method="post" name="form1" class="style2" id="form1" onSubmit="return validates()">
  <p>&nbsp;</p>
 <center><font color=blue size=5><U>Borrow Return Form</U></font></center> <br><br>
